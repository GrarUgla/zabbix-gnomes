...
parser = argparse.ArgumentParser(formatter_class=argparse.RawDescriptionHelpFormatter,
                                 description='Tries to unlink Zabbix hosts from the specified templates. Hosts can be specified seperately or by hostgroups.',
                                 epilog="""
...
group.add_argument('-G', '--hostgroups', help='Unlink all the hosts in the specified hostgroup(s) from the template(s)',
                   nargs='+')
...
parser.add_argument('-N', '--noclear',
                    help='Unlink Templates, but don\'t clear. Default is to perform an "unlink and clear"',
                    action='store_true')
...
parser.add_argument('-n', '--numeric', help='Use numeric ids instead of names, applies to -t, -H and -G',
                    action='store_true')
