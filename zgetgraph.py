...
parser = argparse.ArgumentParser(formatter_class=argparse.RawDescriptionHelpFormatter,
                                 description='Downloads a graph from Zabbix frontend', epilog="""
...
if graph:
    ...
    try:
        if session.cookies['zbx_sessionid']:
            ...
            graphurl = api + "/" + generator + "?graphid=" + str(graphid) + "&period=" + str(period) + "&width=" + str(
                width) + "&height=" + str(height) + "&stime=" + str(stime)
