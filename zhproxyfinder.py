...
parser = argparse.ArgumentParser(formatter_class=argparse.RawDescriptionHelpFormatter,
                                 description='Tries to get the assigned Zabbix proxy for the specified Zabbix host.',
                                 epilog="""
...
parser.add_argument('-e', '--extended', help='Return both proxyid and proxy name separated with a ":"',
                    action='store_true')
