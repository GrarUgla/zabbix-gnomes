...
parser = argparse.ArgumentParser(formatter_class=argparse.RawDescriptionHelpFormatter,
                                 description='Updates properties of a Zabbix host.', epilog="""
...
group.add_argument('-S', '--sync-names', help='Sets hostname and visible name to the name specified with -N',
                   action='store_true')
parser.add_argument('-I', '--inventory', help='Update inventory fields. Specify each field as \'fieldname="value"\'.',
                    nargs='+')
group2.add_argument('-M', '--macros',
                    help='Update or add macros. Specify each field as \'"macro"="value"\'. Don\'t add {$...} characters, this script will handle that for you.',
                    nargs='+')
group2.add_argument('-R', '--remove-macros',
                    help='Remove macros. Don\'t add {$...} characters, this script will handle that for you.',
                    nargs='+')
