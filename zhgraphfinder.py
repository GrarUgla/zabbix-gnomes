...
parser = argparse.ArgumentParser(formatter_class=argparse.RawDescriptionHelpFormatter,
                                 description='Tries to get the configured graphs for the specified Zabbix host.',
                                 epilog="""
...
parser.add_argument('-e', '--extended', help='Return both graphid and graph name separated with a ":"',
                    action='store_true')
