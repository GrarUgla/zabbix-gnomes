...
parser = argparse.ArgumentParser(formatter_class=argparse.RawDescriptionHelpFormatter,
                                 description='Tries to link Zabbix hosts to the specified templates. Hosts can be specified seperately or by hostgroups.',
                                 epilog="""
...
group.add_argument('-G', '--hostgroups', help='Link all the hosts in the specified hostgroup(s) to the template(s)',
                   nargs='+')
